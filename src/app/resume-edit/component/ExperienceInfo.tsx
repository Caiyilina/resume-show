...
import { ExperienceInfo } from "@/app/store/resumeEdit";

type Props = {
  data: ExperienceInfo[];
  onChange: (index: number, field: keyof ExperienceInfo, value: any) => void;
  onAdd: () => void;
  onRemove: (index: number) => void;
};

const ExperienceInfoComponent = ({
  data,
  onChange,
  onAdd,
  onRemove,
    ...
    <div className="bg-neutral rounded-xl p-6 card-shadow">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-dark flex items-center">
          <i className="fa-solid fa-briefcase text-primary mr-2"></i>工作经历
        </h2>
      ...
      {isExpanded && (
        <div id="experience-container">
          {data.map((item, index) => (
            <div
              className="experience-item space-y-4 mt-4 border-t pt-4"
              key={index}
            >
...
export default ExperienceInfoComponent;
